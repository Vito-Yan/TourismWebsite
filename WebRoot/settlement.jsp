...
<li><img src="<%=path%>/images/n3.jpg" width="205" height="62" id="three"/></li>
<li></li>
</ul>
</div>
<form action="<%=path%>/OrderManagerServlet?flag=_set" method="post" id="commentForm">
...
<div class="dingdan-infm">填写游客信息&nbsp;&nbsp;&nbsp;&nbsp;<span>请准确填写游客信息。</span>
  ...
  <input type="text" class="txt" size="10" name="td" id="td" value="${td}"  readonly="readonly"></input>
  </span></div>
...
<div class="dingdan-mm">
  ...
  <li>
      <span>*</span> 真实姓名 
      <input name="realName" type="text" value="${rNames[calc.index]}" id="realName"  readonly="readonly" class="txt" size="20" />
  </li>
   <li>
         <span>*</span> 手机 
          <input name="tel" type="text"  value="${tels[calc.index]}" id="tel" size="20" readonly="readonly"  class="txt" />
   </li>
   <li>
     <span>*</span> 身 份 证&nbsp;
     <input name="IdCard" type="text"  value="${IdCards[calc.index]}" id="IdCard"  readonly="readonly"  class="txt" size="20" />
   </li>
    </ul>
  </div>
</div>
</c:forEach>
<div class="jine">应付总额：<span>${totals}</span>元</div>
<div class="xyb">
  <input name="button" type="image" id="button" onclick="next();" value="提交" src="<%=path%>/images/js.jpg" />
</div>
</div>
</form>
</div>
